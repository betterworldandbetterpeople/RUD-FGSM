...
tf.flags.DEFINE_string(
    'output_dir', '/data/ml/Attack_new/adv_images/0.8_NAG_adv_images_inception_v4', 'Output directory with images.')
...
def graph(x, y, i, x_max, x_min, grad):
    ...
    num_classes = 1001
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):  # 作用是给list_ops中的内容设置默认值
