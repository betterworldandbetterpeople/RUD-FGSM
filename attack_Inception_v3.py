...
tf.flags.DEFINE_string(
    'output_dir', '/data/ml/Attack_new/adv_images/0.4_NAG_adv_images_inception_v3', 'Output directory with images.')
...
def graph(x, y, i, x_max, x_min, grad):
    ...
    num_classes = 1001
    with slim.arg_scope(inception_v3.inception_v3_arg_scope()):  # 作用是给list_ops中的内容设置默认值
    ...
    logits = (logits_v3) / 7.25
    auxlogits = (end_points_v3['AuxLogits']) / 6.25
